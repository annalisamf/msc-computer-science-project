...
################ AUTH FOR LOGIN ###################
USERNAME_PASSWORD_PAIRS = [['afogli01', 'bbk'], ['annalisa', 'twitter']]

############# DATA ###############
age = pd.read_pickle('age.pkl')

gender = pd.read_pickle('gender.pkl')

location = pd.read_pickle('location.pkl')
